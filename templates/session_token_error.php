...
<a class="button button-primary button-hero load-customize" href="http://jumpout.makedreamprofits.ru/api/allow_access/?back_url=http://<?php echo $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI']?>">
